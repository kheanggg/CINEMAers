...
export default function ConfirmBooking({
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center">
            <div id="seat-selection-modal" className="grid grid-cols-[62%_37%] w-[60%] h-[70%] gap-3">
                <div className="px-10 py-10 bg-[#1D1B1B] rounded-xl border border-white border-opacity-50 h-[70%] my-auto">
                    <div className="flex flex-col gap-5">
                        <div className="flex flex-col">
                            <label className="text-2xl">Email:</label>
                            <input type="text" className="rounded px-2 py-2 my-2 bg-[#282525]" />
                        </div>
                        ...
                        <div
                            ...
                            onClick={() => {
                                if (isValidInput) {
                                    ...
                                    alert("Invalid payment information. Please check your Card Number, Expiry Date, and CVV.");
                                }
                            }}
                        >
